...
class LocalTools:
    ...
    def list_dir(self, path: str = ".", max_items: int | None = None, include_size: bool = False, show_hidden: bool = False, file_pattern: str | None = None) -> ToolResult:
        return _list_dir_impl(
