...
| **工具箱** | `tooling/local_tools.py` | 55% | **中**: 基础 IO 完备，缺 Patch/RAG。 |
| **安全策略** | `policy/command_policy.py` | 65% | **中**: Denylist 完备，缺动态权限流。 |
| **审计追溯** | `observability/audit.py` | 60% | **中**: JSONL 全记录，缺回放/可视化。 |
...
### 第一阶段：编辑稳定性 (P0)
- **Patch Engine**: 引入 `apply_patch` 工具，支持 Search-Replace 块编辑。
